// frontend/src/pages/Excedentes.jsx
/**
 * Excedentes de Campaña
 * CRUD de la tabla excedentes (id, venta_id, excedente, fecha)
 * Antes se llamaba "Donaciones" visualmente. Renombrado a "Excedentes".
 * venta_id se usa como "Código de Caja (opcional)".
 */
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
          Gestión de los excedentes registrados en las ventas de cajas (montos adicionales donados por los benefactores).
